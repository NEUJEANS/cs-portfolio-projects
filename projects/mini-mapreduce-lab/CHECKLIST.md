...
- [ ] Add a rolling-window joins plugin example so the lab can compare multi-stream correlation against the existing score/latency/sessionization/windowing/out-of-order stories
