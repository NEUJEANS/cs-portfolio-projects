...
- clean CLI commands for validation and simulation

## Project structure
- `two_phase_commit_lab.py` - validator, simulator, Markdown renderer, and CLI entrypoint
...
- `docs/artifacts/two-phase-commit-lab/` - committed example Markdown reports generated from the sample scenarios
...
## Future ideas
- add a directory-level catalog command that compares several committed scenarios in one artifact bundle
