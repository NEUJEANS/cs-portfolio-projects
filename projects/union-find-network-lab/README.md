...
- now renders standalone SVG charts from benchmark or CSV-import artifacts without pulling in plotting dependencies
...
- SVG chart export for benchmark-series throughput and CSV-import component-growth artifacts
