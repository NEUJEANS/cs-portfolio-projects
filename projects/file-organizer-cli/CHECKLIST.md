...
- [x] regression coverage for preset export/import, lint warnings/errors, and invalid config guards
...
- [ ] add an optional `--fix-config` / normalized-config writer for teams that want lint warnings auto-resolved into canonical JSON
