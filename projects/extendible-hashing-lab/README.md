...
- add a small theory/annotation panel that compares observed linear-probing hit/miss probe costs against the classic load-factor expectations so the benchmark tells an even stronger interview story
