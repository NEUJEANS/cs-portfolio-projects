...
- Edmonds-Karp averaged 1.46x faster than Dinic on this dag suite, which is a useful reminder that small pure-Python workloads can invert the asymptotic story.
- Mean max flow across trials: `26.2` with mean edge density `0.131`.
- Edmonds-Karp mean runtime: `0.245` ms with `7.0` mean augmentations.
- Dinic mean runtime: `0.357` ms with `7.0` mean augmentations and `3.4` mean phases.

## Trial table

| Trial | Seed | Edges | Density | Max flow | Edmonds-Karp ms | EK augmentations | Dinic ms | Dinic augmentations | Dinic phases |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | 42 | 78 | 0.141 | 28 | 0.286 | 7 | 0.386 | 7 | 3 |
| 2 | 43 | 73 | 0.132 | 23 | 0.222 | 5 | 0.288 | 5 | 2 |
| 3 | 44 | 74 | 0.134 | 21 | 0.179 | 3 | 0.278 | 3 | 2 |
| 4 | 45 | 66 | 0.12 | 34 | 0.312 | 12 | 0.483 | 12 | 6 |
| 5 | 46 | 70 | 0.127 | 25 | 0.224 | 8 | 0.35 | 8 | 4 |
