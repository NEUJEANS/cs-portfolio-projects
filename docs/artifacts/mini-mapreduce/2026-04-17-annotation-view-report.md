...
- Collapsed reviewer callouts: Collapsed 1 additional structured reviewer callout(s) after the first 1 visible annotation(s). Hidden titles: Integration review backlog.

## Structured benchmark annotations

### Annotation view

- Total structured annotations: `3`
- Matched annotations after filtering: `2`
- Rendered annotation cards: `2`
- Severity filter: `risk, watch`
- Annotation limit: `1`
- Overflow mode: `summary`
- Hidden by severity filter: `1`
- Hidden by annotation limit: `1`
- Overflow summary card emitted: `true`
...
### Collapsed reviewer callouts
- Detail: Collapsed 1 additional structured reviewer callout(s) after the first 1 visible annotation(s). Hidden titles: Integration review backlog.
- Severity: `info`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 2 | 5.148 | 8 | 240 | 21 | 71 | 1.34 |
| 4 | 4.857 | 8 | 240 | 21 | 40 | 1.509 |
