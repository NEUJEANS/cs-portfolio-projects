...
- [ ] generate and commit anti-entropy artifact bundles for `sample_ops.json` and `sample_compare_ops.json`
- [ ] update README usage, artifact examples, and future follow-up notes
- [ ] add regression coverage for anti-entropy summaries and CLI export wiring
