# Mini MapReduce GitHub source links slice

Date: 2026-04-16 05:21 UTC
Project: `mini-mapreduce-lab`

## Slice goal
Make `inspect-plugin` artifacts publishable by adding branch-aware GitHub blob links alongside local file anchors.
