# karger-min-cut-lab checklist

- [x] pick a portfolio-worthy randomized graph algorithm project
- [x] implement a runnable multigraph model and contraction engine
- [x] support repeated deterministic trials with seed control
- [x] add an exact verifier for small graphs
...
- [x] short refresh and self-test captured for Karger success-probability intuition and family-specific min cuts
- [x] add a resumable slice checklist entry
- [x] implement benchmark/reporting mode across cycle, complete, barbell, and Erdos-Renyi graph families
- [x] emit JSON and CSV benchmark artifacts for committed portfolio evidence
- [x] document benchmark usage and artifact interpretation in the project README
- [x] add unit tests for graph-family builders, benchmark summaries, and CLI artifact output
- [x] run tests
- [x] complete review pass 1 and fix issues
- [x] complete review pass 2 and fix issues
- [x] complete review pass 3 and fix issues
