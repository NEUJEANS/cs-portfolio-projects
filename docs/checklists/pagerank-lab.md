...
- [x] implement graph parser, iterative PageRank engine, and CLI commands
- [x] add sample graph input and unit tests for convergence, normalization, and dangling-node behavior
- [x] run tests
