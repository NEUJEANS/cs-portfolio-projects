...
- [x] choose Fenwick tree lab as the next advanced data-structure slice
- [x] do brief research on Fenwick tree capabilities and portfolio framing
- [x] refresh lowbit, prefix-sum, and dual-tree range-update concepts
